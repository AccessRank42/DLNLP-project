...
# from https://github.com/abisee/cs224n-win18-squad/blob/master/code/preprocessing/download_wordvecs.py
# updated for python 3
# modified to download glove.840B.300d.zip from glove.6B.zip
...
def main():
    ...
    maybe_download(glove_base_url, glove_filename, args.download_dir, 2176768927)
