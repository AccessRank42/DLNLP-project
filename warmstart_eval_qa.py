...
ARTIFACTS = Path("artifacts_torch")
...
def logits_to_text(all_results, tokenizer, dataset):
    predictions = {}
    ...
    for r in all_results:
        ...
        tokens = tokenizer.convert_ids_to_tokens(r["input_ids"][s:e+1])
...
def normalize(s):
    ...
    return white(remove_articles(remove_punc(s.lower())))
...
def main():
    ...
    # 4
    preds = logits_to_text(all_results, tokenizer, ds)
